...
class mod(commands.Cog):
  ...
  async def kick(self, ctx, member: discord.Member, *, reason=None):
    ...
    if isinstance(ctx.channel, discord.channel.DMChannel):
      await ctx.send(random.choice(unusable_cmd_in_dms))  
  ...
  async def slowmode(self, ctx, sec: int = None):
    if sec == None:
      await ctx.reply(random.choice(slowmode_no_num), mention_author=True)
    if sec == '0':
      await ctx.reply(random.choice(slowmode_off), mention_author=False)
  ...
  async def roleadd(self, ctx, member: discord.Member = None, *, role: discord.Role = None):
    ...
    if isinstance(ctx.channel, discord.channel.DMChannel):
      ...
      await ctx.reply(random.choice(role_no_user), mention_author=True)
      return
    elif role == None:
      await ctx.reply(random.choice(role_give_no_role_mention), mention_author=True)
  ...
  async def roleremove(self, ctx, member: discord.Member = None, *, role: discord.Role = None):
    ...
    if isinstance(ctx.channel, discord.channel.DMChannel):
      ...
      await ctx.reply(random.choice(role_revoke_no_role_mention), mention_author=True)
  ...
  async def nick(self, ctx, member: discord.Member = None, *, nick = None):
    ...
    if isinstance(ctx.channel, discord.channel.DMChannel):
      ...
      await ctx.reply(random.choice(nick_no_member), mention_author=True)
    elif nick == None:
      await ctx.reply(random.choice(nick_no_name), mention_author=True)
  ...
  async def userinf(self, ctx, *, member:discord.Member = None):
    if isinstance(ctx.channel, discord.channel.DMChannel):
      ...
      await ctx.reply(random.choice(userinf_no_member_mention), mention_author=True)
  ...
  async def kick_error(self, ctx, error):
    if isinstance(error, commands.MissingRequiredArgument):
      await ctx.send(random.choice(err_kick), mention_author=True)

  @ban.error
  async def ban_error(self, ctx, error):
    if isinstance(error, commands.MissingRequiredArgument):
      await ctx.send(random.choice(err_ban), mention_author=True)

  @unban.error
  async def unban_error(self, ctx, error):
    if isinstance(error, commands.MissingRequiredArgument):
      await ctx.send(random.choice(err_unban), mention_author=True)
